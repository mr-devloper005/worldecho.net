export const siteIdentity = {
  code: process.env.NEXT_PUBLIC_SITE_CODE || 'worldecho',
  name: process.env.NEXT_PUBLIC_SITE_NAME || 'Worldecho',
  ...
  domain: process.env.NEXT_PUBLIC_SITE_DOMAIN || 'worldecho.net',
  url: process.env.NEXT_PUBLIC_SITE_URL || 'https://worldecho.net',
